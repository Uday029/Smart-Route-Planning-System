...
# 4. Architecture
add_content_slide("3. System Architecture (MVC)", [
    "The project strictly follows the Model-View-Controller (MVC) design pattern:",
    "Model (Data & Logic):",
    "    Contains the raw entities: City, Road (Edge), and Graph.",
    "    Maintains the state of the road network and real-world geographic coordinates.",
    "View (User Interface):",
    "    Built entirely with Java Swing and FlatLaf.",
    "    Custom MapPanel normalizes GPS coordinates to render the 2D visual map.",
    "Controller (Data Processing):",
    "    Acts as the bridge between UI inputs and backend algorithms.",
    "    RoutingAlgorithms and NearbyPlacesFinder execute complex graph traversals."
])

# 5. File Structure
add_content_slide("4. File & Package Structure", [
    "The source code is cleanly modularized into distinct Java packages:",
    "com.routeplanner.model:",
    "    Entity classes (City.java, Road.java, Graph.java, Place.java)",
    "com.routeplanner.ui:",
    "    Frontend visual components (MainFrame.java, MapPanel.java)",
    "com.routeplanner.dsa:",
    "    Core algorithmic engines (RoutingAlgorithms.java, NearbyPlacesFinder.java)",
    "com.routeplanner.manager:",
    "    Business logic and cost calculators (TollFuelCalculator.java)",
    "com.routeplanner.dao:",
    "    Data Access Objects for persistent storage interactions (CityDAO.java)"
])
...
prs.save('/Users/mac/Desktop/SmartRoutePlanner/Project_Presentation_V3.pptx')
